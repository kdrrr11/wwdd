  ...
  return (
    <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-xl p-4 md:p-6 border border-blue-500/30 mb-4 md:mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div className="flex items-center space-x-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-xs md:text-sm text-gray-400">Days Remaining</p>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-xs md:text-sm text-gray-400">Earnings Limit</p>
            <p className="text-base md:text-lg font-semibold text-white">
          ...
          <div className="flex items-start space-x-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-300 text-xs mt-1">
                Upgrade to a premium package to continue mining and earning unlimited rewards.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
        ...
        >
          {isTrialActive ? 'Start Mining' : 'Trial Expired'}
        </Link>
